...
const AppProfileSidebar = () => {
    ...
    const rightMenuActive = useRef(null);
    ...
    const onRightMenuHide = () => {
        ...
        console.log('Right nmenú');

    };

    return (
        <Sidebar visible={false} onHide={onRightMenuHide} baseZIndex={1000} position="right" showCloseIcon={false}>
            <div className="p-3">
